<x-admin-layout>
    ...
    <form method="post" action="{{route('admin.rental.save')}}" enctype="multipart/form-data">
        @csrf
        @if(isset($trademark))
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="name" id="name" value="{{isset($trademark) ? $trademark->name : null}}">
                @error('name')
